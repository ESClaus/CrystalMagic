...
public class OreGeneration {
    ...
    public static void registerOres() {
        RegistryKey<ConfiguredFeature<?, ?>> oreCrystalOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_KEY,
        ...
        RegistryKey<ConfiguredFeature<?, ?>> oreCrystalNether = RegistryKey.of(Registry.CONFIGURED_FEATURE_KEY,
        ...
        RegistryKey<ConfiguredFeature<?, ?>> oreCrystalEnd = RegistryKey.of(Registry.CONFIGURED_FEATURE_KEY,
